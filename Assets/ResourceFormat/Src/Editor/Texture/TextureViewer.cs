    ...
    public class TextureViewer : BaseViewer {
        ...
        public TextureViewer(EditorWindow hostWindow) {
           // m_hostWindow = hostWindow;
            ...
            m_dataTable.AddColumn("RootPath", "PackageRootPath", 0.30f, TextAnchor.MiddleLeft);
            ...
            m_dataTable.AddColumn("TexType", "TextureType", 0.1f);
            m_dataTable.AddColumn("ShapeType", "TextureShape", 0.04f);
            m_dataTable.AddColumn("AlphaMode", "AlphaMode", 0.05f);
            m_dataTable.AddColumn("AndroidFormat", "AndroidFormat", 0.09f);
            m_dataTable.AddColumn("IosFormat", "IosFormat", 0.09f);
            ...
            m_showTable.AddColumn("Path", "Path", 0.55f, TextAnchor.MiddleLeft);
        ...
        public override void Draw(Rect r) {
            ...
            GUILayout.BeginHorizontal(TableStyles.Toolbar);
            {
                ...
                if (GUILayout.Button("Refresh Data", TableStyles.ToolbarButton, GUILayout.MaxWidth(140))) {
